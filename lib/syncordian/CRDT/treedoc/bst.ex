defmodule Syncordian.CRDT.Treedoc.Bst do
  @moduledoc """
  A binary search tree abstract data structure.
  """

  alias Syncordian.CRDT.Treedoc.Node
  ...
  @type t :: %__MODULE__{root: Node.t() | nil, comparator: comparator()}
  ...
  """
  @spec new() :: tree()
  def new_peer(), do: new([], fn a, b -> a.id - b.id end)
